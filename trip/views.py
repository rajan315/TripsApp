...
class TripCreateView(CreateView):
    ...
    # template required with name model_form.html
    
    def form_valid(self, form):  #Everytime user write info this method will be called and check that all fields are correct and then save to db
...
class TripDetailView(DetailView):
    ...
    # data stored on trip also have the notes
